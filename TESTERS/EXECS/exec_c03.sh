...
then
 ...
 cat "$FILE.c" >> test.c
 cat ~/piscine-testers-42/TESTERS/c03/test_"$FILE".c >> test.c
 ...
 sleep .3
 ./a.out > output.txt
 cat ~/piscine-testers-42/TESTERS/c03/test_"$FILE".txt >> expected.txt
...
run_test ex00 ft_strcmp
run_test ex01 ft_strncmp
run_test ex02 ft_strcat
run_test ex03 ft_strncat
run_test ex04 ft_strstr
run_test ex05 ft_strlcat
