...
then
 ...
 cat "$FILE.c" >> test.c
 cat ~/piscine-testers-42/TESTERS/c01/test_"$FILE".c >> test.c
 ...
 sleep .3
 ./a.out > output.txt
 cat ~/piscine-testers-42/TESTERS/c01/test_"$FILE".txt >> expected.txt
...
run_test ex00 ft_ft
run_test ex01 ft_ultimate_ft
run_test ex02 ft_swap
run_test ex03 ft_div_mod
run_test ex04 ft_ultimate_div_mod
